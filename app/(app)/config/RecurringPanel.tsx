    ...
    <section id="fixos" className="card p-4 flex flex-col gap-3 scroll-mt-4">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-[13px] text-ink-2">Aluguel, financiamento, faculdade, assinaturas. Eu lanço no dia certo (fica "sem extrato" até o banco confirmar) e desconto do livre pra gastar antes de cair.</p>
        </div>
